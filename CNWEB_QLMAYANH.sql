...
alter proc SearchPrice
 ...
 select IDMAY, TENMAY, HINHANH, DONGIA, MAYANH.IDLOAIMAY, LOAIMAY.TENLMAY 
 from MAYANH,LOAIMAY 
 where MAYANH.IDLOAIMAY = LOAIMAY.IDLOAIMAY
 and TENMAY like N'% Canon%' and TENLMAY like N'% Mới %' and DONGIA >= 10000000 and DONGIA <= 15000000